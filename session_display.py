...
# Form implementation generated from reading ui file 'D:\Desktop\ART TUTORIALS\SHORTCUTS & STUFF\Inkdrawing\ui\display_session.ui'
#
...
class Ui_session_display(object):
    def setupUi(self, session_display):
        ...
        self.session_info.setMinimumSize(QtCore.QSize(75, 25))
        self.session_info.setMaximumSize(QtCore.QSize(75, 25))
        font = QtGui.QFont()
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/grid_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.contrast_button = QtWidgets.QPushButton(session_display)
        self.contrast_button.setMinimumSize(QtCore.QSize(40, 0))
        self.contrast_button.setMaximumSize(QtCore.QSize(40, 16777215))
        self.contrast_button.setFocusPolicy(QtCore.Qt.NoFocus)
        self.contrast_button.setStyleSheet("background: rgb(130, 130, 130);")
        self.contrast_button.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/icons/contrast.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.contrast_button.setIcon(icon3)
        self.contrast_button.setIconSize(QtCore.QSize(15, 15))
        self.contrast_button.setCheckable(False)
        self.contrast_button.setObjectName("contrast_button")
        self.horizontalLayout.addWidget(self.contrast_button)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/lock_scale.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.lock_scale_button.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/icons/flip horizontal.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.flip_horizontal_button.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/icons/flip vertical.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.flip_vertical_button.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/icons/arrow left.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.previous_image.setIcon(icon7)
        ...
        self.pause_timer.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/icons/Square.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.stop_session.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/icons/arrow right.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.next_image.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icons/icons/copy-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.copy_image_path_button.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icons/icons/folder-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.open_folder_button.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icons/icons/trash-can.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.delete_image_button.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icons/icons/settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.show_main_window_button.setIcon(icon14)
        ...
        self.timer_display.setMaximumSize(QtCore.QSize(100, 25))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(15)
        font.setBold(True)
