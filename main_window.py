...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_5.addWidget(self.theme_options_button)
        self.labels_options_button = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(73)
        sizePolicy.setVerticalStretch(20)
        sizePolicy.setHeightForWidth(self.labels_options_button.sizePolicy().hasHeightForWidth())
        self.labels_options_button.setSizePolicy(sizePolicy)
        ...
        self.verticalLayout_5.addWidget(self.labels_options_button)
        ...
        self.delete_images_preset = QtWidgets.QPushButton(self.centralwidget)
        self.delete_images_preset.setMinimumSize(QtCore.QSize(100, 25))
        self.delete_images_preset.setMaximumSize(QtCore.QSize(100, 25))
        font = QtGui.QFont()
        ...
        self.delete_images_preset.setToolTip("")
        ...
        self.verticalLayout.addWidget(self.delete_images_preset)
        ...
        self.verticalLayout_3.setContentsMargins(0, 1, -1, 24)
        ...
        self.update_preset_button = QtWidgets.QPushButton(self.centralwidget)
        self.update_preset_button.setMinimumSize(QtCore.QSize(50, 22))
        self.update_preset_button.setMaximumSize(QtCore.QSize(77, 16777215))
        self.update_preset_button.setStyleSheet("background: rgb(220,220,220); color: \'black\';")
        self.update_preset_button.setObjectName("update_preset_button")
        self.verticalLayout_3.addWidget(self.update_preset_button)
        ...
        self.table_images_selection = QtWidgets.QTableWidget(self.centralwidget)
        self.table_images_selection.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.table_images_selection.sizePolicy().hasHeightForWidth())
        self.table_images_selection.setSizePolicy(sizePolicy)
        self.table_images_selection.setMinimumSize(QtCore.QSize(300, 300))
        self.table_images_selection.setMaximumSize(QtCore.QSize(500, 300))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.table_images_selection.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.table_images_selection.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.table_images_selection.setAutoScroll(True)
        self.table_images_selection.setAutoScrollMargin(20)
        self.table_images_selection.setEditTriggers(QtWidgets.QAbstractItemView.DoubleClicked)
        self.table_images_selection.setTabKeyNavigation(False)
        self.table_images_selection.setDragDropOverwriteMode(False)
        self.table_images_selection.setAlternatingRowColors(False)
        self.table_images_selection.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.table_images_selection.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.table_images_selection.setShowGrid(True)
        self.table_images_selection.setCornerButtonEnabled(True)
        self.table_images_selection.setObjectName("table_images_selection")
        self.table_images_selection.setColumnCount(1)
        ...
        font.setWeight(50)
        item.setFont(font)
        self.table_images_selection.setHorizontalHeaderItem(0, item)
        self.table_images_selection.horizontalHeader().setDefaultSectionSize(50)
        self.table_images_selection.horizontalHeader().setHighlightSections(False)
        self.table_images_selection.horizontalHeader().setMinimumSectionSize(35)
        self.table_images_selection.horizontalHeader().setStretchLastSection(True)
        self.table_images_selection.verticalHeader().setVisible(False)
        self.table_images_selection.verticalHeader().setHighlightSections(False)
        self.table_images_selection.verticalHeader().setStretchLastSection(False)
        self.gridLayout_4.addWidget(self.table_images_selection, 1, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.search_preset, 0, 1, 1, 1)
        ...
        self.set_number_of_images.setStyleSheet("background: rgb(70,70,70); color: \'white\';")
        ...
        self.start_session_button.setContextMenuPolicy(QtCore.Qt.PreventContextMenu)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.delete_images_preset.setText(_translate("MainWindow", "Delete Preset"))
        ...
        self.update_preset_button.setText(_translate("MainWindow", "Update preset"))
        self.add_folders_button.setText(_translate("MainWindow", "Add Folders"))
        item = self.table_images_selection.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Images presets"))
